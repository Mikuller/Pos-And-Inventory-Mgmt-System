...
Route::group(['prefix' => 'products', 'as' => 'product.', 'middleware' => ['auth', 'can:admin', 'can:status']], function () {
    ...
    Route::post('/import', [ProductController::class , 'storeImport'])->name('storeImport');
    Route::get('/downloadSample', [ProductController::class , 'downloadSample'])->name('downloadSample');
});
