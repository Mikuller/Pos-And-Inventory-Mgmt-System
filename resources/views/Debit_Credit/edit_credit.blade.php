                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input name="payedPartnerName" type="text" class="form-control"
                                    placeholder="Enter Paid Partner's Name" value="{{session('credit')->payedPartnerName}}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input name="payedPartnerPhone" type="text" class="form-control"
                                    placeholder="Enter Paid Partner's Phone Number" value="{{session('credit')->payedPartnerPhone}}" required>
