                ...
                <div class="col-lg-4">
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('service.pendingServices') }}">Pending services</a>
                            </li>
                        </ol>
                    </nav>
                </div>
                ...
                <div class="card">
                    <div class="card-header row">
                        <div class="col col-sm-2">
                            <a href="{{route('service.create.pendingService')}}" 
                                class="btn btn-primary btn-rounded">Add service</a>
                        </div>
                        ...
                        <table id="advanced_table" class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge badge-pill badge-danger mb-1">{{$pendingService->status}}</span></td>
                                    <td>
                                        <div class="dropdown d-inline-block">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="/purchases/1/edit"><i
                        ...
                        <div class="form-group">
                            ...
                            <div class="border-checkbox-section ml-3">
                                ...
                                <div class="border-checkbox-group border-checkbox-group-success d-block">
                                    ...
                                    <input name="serviceTypeId[]" class="border-checkbox" type="checkbox" id="checkbox{{$serviceType->id}}"
                                        value="{{$serviceType->id}}">
                                    <label class="border-checkbox-label" for="checkbox{{$serviceType->id}}">{{$serviceType->name}}</label>
