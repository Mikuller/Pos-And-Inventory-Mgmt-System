    ...
    @if (session('showMode') && session('service')->exists() ?? false)
        ...
        <div class="modal fade edit-layout-modal pr-0" id="serviceShow" role="dialog"
            ...
            <div class="modal-dialog w-300" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="supplierAddLabel">Show service</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                aria-hidden="true">×</span></button>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="d-block">Customer Name</label>
                            <input type="text" name="customerName" class="form-control"
                                placeholder="Enter Customer Name" value="{{ session('service')->customerName }}" readonly>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="d-inline mb-2"
                                    name="paymentStatus"  value="{{session('service')->paymentStatus}}" 
                                     readonly />
                            <br />
                        ...
                        <div class="form-group">
                            <label class="d-block">Payment Method<span class="text-danger"> *</span></label>
                            <input type="text" class="d-inline mb-2"
                                    name="paymentMethod"  value="{{session('service')->paymentMethod}}" 
                                     readonly />
                            <br />
                        </div>
                        ...
                        <div class="form-group" id="eCashRefNumberWrapper" class="form-group"
                            ...
                            <input class="form-control mt-2 " type="text" name="eCashRefNumber" id="eCashRefNumber"
                                placeholder="Txn Refrence Number" value="{{ session('service')->eCashRefNumber }}" readonly/>
                        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form
                            ...
                            <div class="form-group">
                                <label class="d-block h6">Payment Status <span
                                        class="text-danger">*required*</span></label>
                                <div class="ml-2">
                                    <label class="h5 d-block" for="paid">
                                        <input type="radio" name="paymentStatus" id="paid" value="Paid"
                                            required /> Paid
                                    </label>
                                    <label class="h5 d-block" for="unpaid">
                                        <input type="radio" name="paymentStatus" id="unpaid" value="Unpaid"
                                            required /> Credit
                                    </label>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="d-block h6">Payment Method <span
                                        class="text-danger">*required*</span></label>
                                <div class="ml-2">
