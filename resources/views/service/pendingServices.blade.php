...
@section('content')
    ...
    @include('service.create_pending_service')
    ...
    @if (session('showMode') && session('service')->exists() ?? false)
        @include('service.show_pending_service')
        <script>
            // Open the modal using JavaScript
            $(document).ready(function() {
                    ...
                    <div class="modal-body">
                        <form
                            ...
                            <div class="form-group">
                                ...
                                <select id="nameList" name="searchByMaintainer"
                                    class="form-control">
                                    @php
                                ...
                                <input id="customName" type="text" name="maintainerName" class="form-control"
