                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="form-control h-205" value="{{ $product->description }}" rows="10"></textarea>
                                        @error('description')
                                            <div class="help-block with-errors">
                                                <span class="text-red">{{ $message }}</span>
                                            </div>
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="price" type="text" class="form-control" name="sellingPrice"
                                            placeholder="Enter product selling price" value="{{ $product->sellingPrice }}"
                                            required="">
                                        @error('sellingPrice')
                                            <div class="help-block with-errors">
                                                <span class="text-red">{{ $message }}</span>
